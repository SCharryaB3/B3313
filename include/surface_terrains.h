...
// Surface Types
    ...
    #define SURFACE_NEW_WATER                    0x0002 // 0x0002 // Custom water surface
    #define SURFACE_NEW_WATER_BOTTOM             0x0003 // 0x0003 // Custom water surface bottom marker
    ...
    #define SURFACE_SUPER_SLIPPERY               0x0007
    ...
    #define SURFACE_ELECTRIC                     0x002B // Electric Floor, shocks the player if standing still for too long (skill issue)
